...
export default function Component() {
    ...
    const images = [
        "/placeholder.svg?height=400&width=400&text=Product+Image+1",
    ...
    return (
        <div className="container mx-auto p-4">
            <div className="flex flex-col lg:flex-row gap-8">
                ...
                {/* Product Details */}
                <div className="lg:w-1/2">
                    <h1 className="text-3xl font-bold mb-2">Baton de manioc</h1>
                    ...
                    <Card className="mb-6">
                        <CardContent className="p-4">
                            ...
                            <div className="grid grid-cols-4 gap-2 text-sm">
                                ...
                                <div className="font-semibold">1-4 pieces</div>
                                <div className="font-semibold">5-19 pieces</div>
                                <div className="font-semibold">20+ pieces</div>
                                <div>Price</div>
                                <div>700 FCFA</div>
                                <div>550 FCFA</div>
                                <div>350 FCFA</div>
                    ...
                    <div className="flex gap-4 mb-6">
                        <Button className="flex-1"><ShoppingCartIcon className="mr-2 h-4 w-4" /> Add to Cart</Button>
